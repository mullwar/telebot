...
const methods = {
    ...
    setChatPhoto(chat_id, file, opt) {
        return sendFile.call(this, 'photo', chat_id, file, opt, {}, 'setChatPhoto');
    },
...
function sendFile(type, chat_id, file, opt = {}, methodForm = {}, methodUrl) {
