...
class TeleBot {
  ...
  constructor(cfg) {
    ...
    this.usePlugins = cfg.usePlugins !== undefined ? (cfg.usePlugins || []) : DEFAULT_PLUGINS;
    ...
    // Use default build-in plugins
    if (this.usePlugins) {
      for (let name of this.usePlugins) {
  ...
  use(plugin) {
    return plugin.call(this, this, this.cfg.plugins || {});
  }
