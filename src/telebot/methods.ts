...
TeleBot.prototype.logOut = function() {
    return this.telegramMethod<true>({
        method: "logOut"
    });
};

TeleBot.prototype.close = function() {
    return this.telegramMethod<true>({
        method: "close"
    });
};
...
TeleBot.prototype.copyMessage = function(chat_id, from_chat_id, message_id, optional) {
    return this.telegramMethod<Message>({
        method: "copyMessage",
        required: { chat_id, from_chat_id, message_id },
        optional
...
TeleBot.prototype.unbanChatMember = function(chat_id, user_id, optional) {
    return this.telegramMethod<true>({
...
TeleBot.prototype.unpinChatMessage = function(chat_id, optional) {
    return this.telegramMethod<true>({
...
TeleBot.prototype.unpinAllChatMessages = function(chat_id) {
    return this.telegramMethod<true>({
...
TeleBot.prototype.deleteWebhook = function(optional) {
    return this.telegramMethod<WebhookResponse>({
